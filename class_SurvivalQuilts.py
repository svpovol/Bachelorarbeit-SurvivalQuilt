...
class SurvivalQuilts(): 
    ...
    def __init__(self, K=10, num_bo=50, num_outer=3, num_cv=10, step_ahead=5):
        ...
        #comment out the folowing line for Experiment 1 and Experiment 3  :      
        #self.model_names   = ['CoxPH', 'CoxPHRidge','Weibull', 'LogNormal']
        
        #comment out the folowing line for Experiment 2 and Experiment 4  :
